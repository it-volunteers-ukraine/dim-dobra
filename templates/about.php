...
<div class="container">
    ...
    <section class="about">
        ...
        <p class="about__description description__command">Наша команда волонтерів регулярно віддає свої зусилля, щоб допомогти тим,хто потребує допомоги найбільше.Двічі на місяць ми організовуємо 
            безкоштовне харчування для переселенців у нашому місті,надаючи продукти харчування, засоби гігієни та одяг. </p>
