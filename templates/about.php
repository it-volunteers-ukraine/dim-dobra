...
<div class="container">
    ...
    <section class="about">
        ...
        <p class="about__description">Благодійний фонд "Дім Добра" заснований 21 листопада 2021 року у місті Кривий Ріг, Україна. 
        ...
        <p class="about__description">Наша команда волонтерів регулярно віддає свої зусилля, щоб допомогти тим, хто потребує допомоги найбільше.
        ...
        <p class="about__description">Не обмежуючись лише нашим містом, наші волонтери також виїжджають двічі на місяць до Херсонської області, де годують 
        ...
        <div class="about__contact">
            ...
            <div class="phone">
                ...
                <a class="phone__link" href="tel:+380960292222">+380960292222</a> | <a class="phone__link" href="tel:+380680292222">+380680292222</a> 
            </div>
        </div>
        <div class="work__img"></div>
        <p class="about__description">Поза тим, наш фонд активно займається порятунком та захистом тварин. Ми евакуюємо чотирилапих із зони бойових дій, дбаючи про
        ...
        <p class="about__description">Завдяки вашій щедрості ми зможемо допомогти ще більше тим, хто страждає та потребує нашої допомоги. Разом ми змінюємо життя на краще та 
